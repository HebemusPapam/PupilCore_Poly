...
FILENAME = 'video_explo_PupilCore_N_2.hdf5' # hdf5 file to visualize
...
index_video_labbel = np.where(events['text'].astype('U128') == VIDEO_NAME)
...
def my_rig_binding():
    player.seek(10,reference="absolute-percent")
    print("Move foward")
